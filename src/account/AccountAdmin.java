...
public class AccountAdmin implements Serializable {
    ...
    public AccountAdmin(){
        accountsAdminList.add(new AccountAdmin("Dung1","111111"));
        accountsAdminList.add(new AccountAdmin("Dung2","222222"));
        accountsAdminList.add(new AccountAdmin("Dung3","333333"));
    }
